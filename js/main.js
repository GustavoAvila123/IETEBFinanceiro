...
window.pedirEdicao = (idx) => relatorios.pedirEdicao(idx);
window.salvarEdicaoEntrada = () => relatorios.salvarEdicaoEntrada();
window.salvarEdicaoSaida = () => relatorios.salvarEdicaoSaida();
window.closeEditEntradaModal = () => relatorios.closeEditEntradaModal();
window.closeEditSaidaModal = () => relatorios.closeEditSaidaModal();
