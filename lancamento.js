      ...
      <form class="ls-form" onsubmit="handleLogin(event)" novalidate>
        <div class="ls-field">
          ...
          <div class="ls-input-wrap">
            ...
            <input type="text" id="loginUsuario" class="ls-input" placeholder="Digite seu usuário" autocomplete="username" spellcheck="false" />
          </div>
        </div>
        <div class="ls-field">
          ...
          <div class="ls-input-wrap">
            ...
            <input type="password" id="loginSenha" class="ls-input ls-input--pw" placeholder="Digite sua senha" autocomplete="current-password" />
